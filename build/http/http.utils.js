...
exports.promiseAny = exports.getRequest = exports.postRequest = void 0;
const got_1 = __importDefault(require("got"));
const logging_1 = require("../utils/logging");
exports.postRequest = (url, requestBody, token, headers = {}) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getRequest = (url, token, headers = {}) => __awaiter(void 0, void 0, void 0, function* () {
    const resultHeaders = !!token ? { headers: Object.assign(Object.assign({}, headers), { 'x-auth-token': token }) } : Object.assign({}, headers);
    const { body } = yield got_1.default.get(url, Object.assign(Object.assign({}, resultHeaders), { responseType: 'json' }));
    const anyBody = body;
    if (anyBody.code !== 0) {
        throw new Error(`Request failed: ${url} -> ${anyBody.code} - ${anyBody.msg}`);
    }

export enum CommandType {
  ...
  COMMAND_INDOOR_AI_CRYING_ENABLE = 6024,
  COMMAND_INDOOR_AI_MOTION_ENABLE = 6023,
  COMMAND_INDOOR_AI_PERSON_ENABLE = 6022,
  COMMAND_INDOOR_AI_PET_ENABLE = 6026,
  COMMAND_INDOOR_AI_SOUND_ENABLE = 6025,
  COMMAND_INDOOR_CONTINUE_RECORD_SCHEDULE = 6013,
  COMMAND_INDOOR_DET_SET_ACTIVE_ZONE = 6042,
  COMMAND_INDOOR_DET_SET_MOTION_DETECT_ENABLE = 6040,
  COMMAND_INDOOR_DET_SET_MOTION_DETECT_TYPE = 6045,
  COMMAND_INDOOR_DET_SET_MOTION_SENSITIVITY_IDX = 6041,
  COMMAND_INDOOR_DET_SET_PET_ENABLE = 6047,
  COMMAND_INDOOR_DET_SET_PET_EXPEL_RESPONSOR = 6048,
  COMMAND_INDOOR_DET_SET_PET_EXPEL_RESP_IDX = 6049,
  COMMAND_INDOOR_DET_SET_SOUND_DETECT_ENABLE = 6043,
  COMMAND_INDOOR_DET_SET_SOUND_DETECT_TYPE = 6046,
  COMMAND_INDOOR_DET_SET_SOUND_SENSITIVITY_IDX = 6044,
  COMMAND_INDOOR_EVENT_COUNT = 6053,
  COMMAND_INDOOR_HK_ACTIVE_HOMEKIT = 6061,
  COMMAND_INDOOR_HK_GET_HK_BIND_STATUS = 6062,
  COMMAND_INDOOR_LED_SWITCH = 6014,
  COMMAND_INDOOR_NAS_STORAGE_TYPE = 6050,
  COMMAND_INDOOR_OWNER_STREAM_TYPE = 6052,
  COMMAND_INDOOR_PAN_CALIBRATION = 6017,
  COMMAND_INDOOR_PAN_TURN = 6030,
  COMMAND_INDOOR_PAN_MOTION_TRACK = 6016,
  COMMAND_INDOOR_PAN_SPEED = 6015,
  COMMAND_INDOOR_PUSH_JUMP_TYPE = 6021,
  COMMAND_INDOOR_PUSH_NOTIFY_TYPE = 6020,
  COMMAND_INDOOR_SET_CONTINUE_ENABLE = 6010,
  COMMAND_INDOOR_SET_CONTINUE_TYPE = 6011,
  COMMAND_INDOOR_SET_RECORD_AUDIO_ENABLE = 6012,
  COMMAND_INDOOR_SHOW_SDCARD = 6054,
  COMMAND_INDOOR_TFCARD_NAS_STATUS = 6051,
  COMMAND_IN_TEST_MODE = 6072,
  COMMAND_PLAY_BACK_EVENT_STOP = 1055,
  COMMAND_SET_DETECT_TYPE = 6071,
  COMMAND_SET_PIR_SENSITIVITY = 6070,
  COMMAND_SMARTLOCK_QUERY_BATTERY_LEVEL = 6001,
  COMMAND_SMARTLOCK_QUERY_STATUS = 6000,
}
